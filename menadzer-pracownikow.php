...
if (session_status() == PHP_SESSION_NONE)
	...
	$zapytanie = $polaczenie->prepare('SELECT status, id, dzien, czas_od, czas_do, info_o_pracy, DAYOFWEEK(dzien) as dtyg FROM harmonogram_prac WHERE id_prac=:id AND dzien >= CURDATE() ORDER BY dzien ASC');
