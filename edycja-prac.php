...
$zapytanie = $polaczenie->prepare('UPDATE pracownicy SET imie=:im, nazwisko=:na, email=:em, nr_telefonu=:te, miejscowosc=:mi, adres=:ad, typ_konta=:ty WHERE id_pracownika=:id');
