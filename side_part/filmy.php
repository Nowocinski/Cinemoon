                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        while($wiersz = $rezultat->fetch_assoc())
                        {
                            ...
                            echo '<div class="col-sm-6 col-md-4 col-lg-3"><form action="nasze-filmy.php" method="get"><figure><button type="submit" class="btn btn-link" name="film" value='.$wiersz['grafika'].'>';
                            echo '';
